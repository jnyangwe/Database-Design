...
class DagrForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
        'LastModified':DateTimeWidget(options=dateTimeOptions, usel10n = True),
        'DateCreated':DateTimeWidget(options=dateTimeOptions, usel10n = True),
...
class MetaDataForm(forms.Form):
    ...
    widget=forms.SelectMultiple(attrs={'class':'form-control'}))
    date = forms.DateTimeField(label="Date",required=False, widget=DateTimeWidget(options=dateTimeOptions, usel10n = True))
...
class TimeForm(forms.Form):
    from_date = forms.DateTimeField(label="From Date", widget=DateTimeWidget(options=dateTimeOptions, usel10n = True))
    to = forms.DateTimeField(label="To Date", widget=DateTimeWidget(options=dateTimeOptions, usel10n = True))
